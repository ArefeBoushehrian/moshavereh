...
<?php
$jsonobj = '{
  "abooreyhan": "ابوریحان بیرونی",
  "amirkabir": "امیرکبیر",
  "ebne-sina": "ابن سینا",
  "ebtehaj": "هوشنگ ابتهاج",
  "etesami": "پروین اعتصامی",
  "ferdowsi": "ابوالقاسم فردوسی",
  "hafez": "حافظ",
  "hesabi": "پروفسور حسابی",
  "kadekani": "شفیعی کدکنی",
  "molana": "مولانا",
  "panahi": "حسین پناهی",
  "saadi": "سعدی",
  "sepehri": "سهراب سپهری",
  "shajarian": "استاد شجریان",
  "shariati": "علی شریعتی",
  "takhti": "پهلوان تختی"
}';
